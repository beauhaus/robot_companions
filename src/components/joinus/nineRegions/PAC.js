    ...
    render() {
        return (
            ...
            <g className="home-result" opacity=".5">
                ...
                <text id="OR" fillOpacity="0.7" x="60" y="920"
                    onClick={this.handleClick}>OR</text>
                <path fill="#99583D" d="M173 407h115v90H173z" />
                <text id="WA" x="190" y="920" onClick={this.handleClick}>WA</text>

                <path fill="#29306B" d="M312 406h115v90H312z" />
                <text id="CA" x="330" y="920" onClick={this.handleClick}>CA</text>

                <path fill="url(#top-edge)" d="M449 406h116v90H449z" />
                <text id="AK" fillOpacity="0.5"
                    x="465" y="920" onClick={this.handleClick}>AK</text>

                <path fill="url(#bottom-left)" d="M35 505h116v90H35z" />
                <text id="HI" x="65" fillOpacity="0.7"  y="1120" onClick={this.handleClick}>HI</text>
            </g>
